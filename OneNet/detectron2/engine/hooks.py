...
class IterationTimer(HookBase):
    ...
    def after_train(self):
        ...
        total_time = time.perf_counter() - self._start_time # 总的时间
        total_time_minus_hooks = self._total_timer.seconds() # 去除hooks 的时间
        hook_time = total_time - total_time_minus_hooks # 其他hook 占用的时间
        # 这就是hook 有弱引用 trainer 的好处，可以访问trainer 的iter ...
    ...
    def after_step(self):
        ...
        # but not yet counted
        # 此时 self.trainer.iter 还没有+1 所以后面要+1
...
class PeriodicCheckpointer(_PeriodicCheckpointer, HookBase):
    ...
    def after_step(self):
        ...
        self.step(self.trainer.iter) # 父类会根据
...
class PreciseBN(HookBase):
    ...
    def update_stats(self):
        ...
        with EventStorage():  # capture events in a new storage to discard them
            ...
            # 对实际的bn layer 更新bn.running_mean， bn.running_var
